...
export const LookerGenerative: React.FC = () => {
  ...
  const generatePrompt = (jsonPayloadLookMLExplore: string, modelName: string, viewName: string) => {
    ...
    Make sure to use the following 4 rules:
    ...
    3. Only use pivot field when the Input contains the following keywords: "pivotting" or "pivot".
    4. If the Input does not contain "pivot" or "pivotting", set "pivots" as null. 
    4. Use syntax compatible with Looker matching filters with data types.
    ...
    input: What is the top 10 languages?
    ...
    input:  count per language pivot per year and filter languages: en, fr, de and pt
    output: { "model": "bi_engine_demo", "view": "wiki100_m", "fields": [ "wiki100_m.count","wiki100_m.language"],"filters": {"wiki100_m.language": "en,fr,de,pt"}, "sorts": null,"pivots": ["wiki100_m.year"],"limit": "500"}
  ...
  return (    
    <ComponentsProvider>
      ...
      <Box display="flex" m="large">        
          ...
          <Span fontSize="medium">
          2. Click on the Text Area and type your question to the Explore - <b>example: count per language pivot per year and filter languages: en, fr, de and pt</b>
          </Span>
          <Span fontSize="medium">
