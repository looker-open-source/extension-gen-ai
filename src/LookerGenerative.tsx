...
import { Button, ComponentsProvider, FieldTextArea, Space, Span, SpaceVertical, Spinner, FieldSelect,  ComboboxOptionObject, ComboboxCallback, MaybeComboboxOptionObject } from '@looker/components'
    ...
    <ComponentsProvider>
      ...
      <Box display="flex" m="large">        
          ...
          <Space>
            ...
            <Button onClick={handleClear}>Remove Last Graph</Button>
          </Space>
          <FieldTextArea            
            width="100%"
